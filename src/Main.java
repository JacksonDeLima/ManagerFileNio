...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println("========================");
        System.out.println(persistence.write("Bernardo; bernardo@bernardo.com;28/11/19999;"));
        System.out.println("========================");
        ...
        System.out.println("========================");
        System.out.println(persistence.replace("Joaquin","Lucas;lucas@lucas.com;17/12/1988"));
        System.out.println("========================");
